              ...
              <FormGroup tag="fieldset">
                <FormGroup check className="my-2">
                  <Label check>
                    <Input
                      type="checkbox"
                      checked={typeFilter.has("Part-Time")}
                      onChange={(e) =>
                        e.target.checked
                          ? addType("Part-Time")
                          : removeType("Part-Time")
                      }
                    />
                ...
                <FormGroup check className="my-2">
                  <Label check>
                    <Input
                      type="checkbox"
                      checked={typeFilter.has("Full-Time")}
                      onChange={(e) =>
                        e.target.checked
                          ? addType("Full-Time")
                          : removeType("Full-Time")
                      }
                    />
                ...
                <FormGroup check className="my-2">
                  <Label check>
                    <Input
                      type="checkbox"
                      checked={typeFilter.has("Work from home")}
                      onChange={(e) =>
                        e.target.checked
                          ? addType("Work from home")
                          : removeType("Work from home")
                      }
                    />
